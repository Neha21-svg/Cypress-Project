import RegisterPage1 from "../support/constructweek/RegisterPage.cy";
import LoginPage1 from "../support/constructweek/LoginPage.cy";
import Compare_product1 from "../support/constructweek/Compare_product.cy";
import LogoutPage1 from "../support/constructweek/LogoutPage.cy";
...
describe('Tutorials Ninja', () => {
    const logout_obj = new LogoutPage1();
    const login_obj = new LoginPage1();
    const register_obj = new RegisterPage1();
    const compare_obj = new Compare_product1();
